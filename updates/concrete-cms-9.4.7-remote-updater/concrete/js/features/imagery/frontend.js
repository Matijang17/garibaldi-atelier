(() => {
  var e = {
      1107: () => {
        $("[data-gallery-lightbox=true]").magnificPopup({
          ...
          image: {
            titleSrc: function (e) {
              var t = $("<div />"),
                n = e.el.attr("data-caption");
              t.append(n);
              var i = e.el.attr("data-download-link");
              if (i.length) {
                var a = $("<a></a>");
                a.attr("href", i),
      ...
      1424: () => {
        $(
          "a[data-concrete-link-lightbox=image],a[data-concrete5-link-lightbox=image]"
        ).each(function () {
          $(this).magnificPopup({
            type: "image",
            removalDelay: 500,
          ...
          $(
            "a[data-concrete-link-lightbox=iframe],a[data-concrete5-link-lightbox=iframe]"
          ).each(function () {
            var e = $(this),
              t = 500,
              n = 400;
            $(this).attr("data-concrete-link-lightbox-width") &&
            $(this).attr("data-concrete-link-lightbox-height")
              ? ((t = $(this).attr("data-concrete-link-lightbox-width")),
                (n = $(this).attr("data-concrete-link-lightbox-height")))
              : $(this).attr("data-concrete5-link-lightbox-width") &&
                $(this).attr("data-concrete5-link-lightbox-height") &&
                ((t = $(this).attr("data-concrete5-link-lightbox-width")),
                (n = $(this).attr("data-concrete5-link-lightbox-height"))),
              e.magnificPopup({
                type: "iframe",
                callbacks: {
                  beforeOpen: function () {
                ...
                iframe: { patterns: { website: { index: "", src: "%id%" } } },
                closeOnContentClick: !0,
                midClick: !0,
              });
          });
      ...
      7634: () => {
         ...
         */
        !(function (e, t, n) {
          e.fn.responsiveSlides = function (i) {
            var a = e.extend(
              {
                auto: !0,
                speed: 500,
            ...
            return this.each(function () {
              ...
              var o,
                ...
                f = u.children(),
                m = f.length,
                g = parseFloat(a.speed),
                h = parseFloat(a.timeout),
                ...
                S = function (t) {
                  a.before(t),
                    P
                      ? (f.removeClass(x).css(T).eq(t).addClass(x).css(_),
                        (p = t),
                        setTimeout(function () {
                          a.after(t);
                        }, g))
                      : f
                          .stop()
                          .fadeOut(g, function () {
                            e(this).removeClass(x).css(T).css("opacity", 1);
                          })
                          .eq(t)
                          .fadeIn(g, function () {
                            e(this).addClass(x).css(_), a.after(t), (p = t);
                          });
                };
              if (
                (a.random &&
                ...
                u.addClass(C + " " + y),
                i && i.maxwidth && u.css("max-width", v),
                f.hide().css(T).eq(0).addClass(x).css(_).show(),
                P &&
                  f
                    .show()
                    .css({
                ...
                if (a.pager && !a.manualControls) {
                  ...
                  f.each(function (e) {
                    ...
                    I.append(O),
                    i.navContainer ? e(a.navContainer).append(I) : u.after(I);
                }
                if (
                  (a.manualControls &&
                    (I = e(a.manualControls)).addClass(
                      C + "_tabs " + y + "_tabs"
                    ),
                  ...
                  (a.pager || a.manualControls) &&
                    ((d = I.find("a")),
                    (r = function (e) {
                      d.closest("li").removeClass(w).eq(e).addClass(w);
                    })),
                  a.auto &&
                    (s = function () {
                      c = setInterval(function () {
                        f.stop(!0, !0);
                        var e = p + 1 < m ? p + 1 : 0;
                        (a.pager || a.manualControls) && r(e), S(e);
                      }, h);
                    })(),
                  (l = function () {
                    a.auto && (clearInterval(c), s());
                  }),
                  a.pause &&
                    u.hover(
                      function () {
                  ...
                  (a.pager || a.manualControls) &&
                    (d
                      .bind("click", function (t) {
                        t.preventDefault(), a.pauseControls || l();
                        var n = d.index(this);
                        p === n ||
                          e("." + x).queue("fx").length ||
                          (r(n), S(n));
                  ...
                  var z =
                    ...
                    a.nextText +
                    "</a>";
                  i.navContainer ? e(a.navContainer).append(z) : u.after(z);
                  var E = e("." + y + "_nav"),
                    M = E.filter(".prev");
        ...
        (a = [n(1669)]),
          (i = function (e) {
            var t,
              ...
              k = function (t, n, i, a) {
                ...
                return (
                  (o.className = "mfp-" + t),
                  i && (o.innerHTML = i),
                  a ? n && n.appendChild(o) : ((o = e(o)), n && o.appendTo(n)),
                  o
                );
              },
              I = function (n, i) {
              ...
              T = function () {
                e.magnificPopup.instance ||
                  ((t = new y()).init(), (e.magnificPopup.instance = t));
              },
              P = function () {
            ...
            (y.prototype = {
              ...
              open: function (n) {
                ...
                if (!1 === n.isObj) {
                  ...
                  for (a = 0; a < s.length; a++)
                    if (((r = s[a]).parsed && (r = r.el[0]), r === n.el[0])) {
                      t.index = a;
                      break;
                    }
                } else
              ...
              updateItemHTML: function () {
                ...
                if (
                  ...
                  I("FirstMarkupParse", o), (t.currTemplate[i] = !o || e(o));
                }
                a &&
                  a !== n.type &&
              ...
              (e.fn.magnificPopup = function (n) {
                ...
                if ("string" == typeof n)
                  if ("open" === n) {
                    var a,
                      o = b ? i.data("magnificPopup") : i[0].magnificPopup,
            ...
            var S,
              ...
              E = "inline",
              M = function () {
                z && (O.after(z.addClass(S)).detach(), (z = null));
              };
                  ...
                  if ((M(), n.src)) {
                    ...
                    if (o.length) {
                      ...
                      r &&
                        r.tagName &&
                        (O ||
                          ((S = a.hiddenClass), (O = k(S)), (S = "mfp-" + S)),
                        (z = o.after(O).detach().removeClass(S))),
                        t.updateStatus("ready");
                    } else
                      t.updateStatus("error", a.tNotFound), (o = e("<div>"));
            ...
            e.magnificPopup.registerModule("zoom", {
              ...
              proto: {
                ...
                _getOffset: function (n) {
                  ...
                  var s = {
                    width: i.width(),
                    height: (b ? i.innerHeight() : i[0].offsetHeight) - r - o,
                  };
                  return (
                    W()
              ...
              proto: {
                initGallery: function () {
                  ...
                  (o += " mfp-gallery"),
                    ...
                    x(u + a, function (e, i, a, o) {
                      var r = t.items.length;
                      a.counter = r > 1 ? R(n.tCounter, o.index, r) : "";
                    }),
          ...
          void 0 === (o = "function" == typeof i ? i.apply(t, a) : i) ||
            (e.exports = o);
      },
      1669: (e) => {
        "use strict";
